...
! function(u) {
	...
	u.extend(u, {
		...
		getElementOffset: function(e) {
			var t, i = (e = u.getElement(e)) && e.ownerDocument,
				n = {
					top: 0,
					left: 0
				};
		...
		makeAjaxRequest: function(e, t, i) {
			...
			try {
				...
				r && (l.responseType = r);
				if (o)
					for (var c in o) Object.prototype.hasOwnProperty.call(o, c) && o[c] && l.setRequestHeader(c, o[c]);
			...
			if (m.isPlainObject(e = null === e ? {} : e)) {
				...
				if (t) {
					...
					if (this.referenceStrip && this.referenceStrip.miniViewers)
						for (var n in this.referenceStrip.miniViewers) this.referenceStrip.miniViewers[n].setAjaxHeaders(this.ajaxHeaders, !0)
				}
			...
			function s() {
				...
				for (; n._loadQueue.length && (e = n._loadQueue[0]).tileSource;) {
					...
					if (e.options.replace) {
						var i = n.world.getIndexOfItem(e.options.replaceItem); - 1 !== i && (e.options.index = i);
...
! function(h) {
	...
	h.TileSource.determineType = function(e, t, i) {
		for (var n in OpenSeadragon)
			if (n.match(/.+TileSource$/) && h.isFunction(OpenSeadragon[n]) && h.isFunction(OpenSeadragon[n].prototype.supports) && OpenSeadragon[n].prototype.supports.call(e, t, i)) return OpenSeadragon[n];
...
! function(p) {
	...
	p.extend(p.DziTileSource.prototype, p.TileSource.prototype, {
		...
		configure: function(e, t, i) {
			...
			if (t && !e.tilesUrl) {
				e.tilesUrl = t.replace(/([^/]+?)(\.(dzi|xml|js)?(\?[^/]*)?)?\/?$/, "$1_files/"); - 1 !== t.search(/\.(dzi|xml|js)\?/) ? e.queryParams = t.match(/\?.*/) : e.queryParams = ""
			}
			return e
		},
		getTileUrl: function(e, t, i) {
	...
	h.IIIFTileSource = function(e) {
		...
		if (this.sizes) {
			...
			if (l === e.maxLevel || l === e.maxLevel + 1) {
				...
				l === e.maxLevel && this.levelSizes.push({
					width: this.width,
					height: this.height
				})
			}
		...
		getImageInfo: function(e) {
			...
			a.addEvent(t, "error", function() {
				i.raiseEvent("open-failed", {
					message: "Error cargando imagen en " + e,
					source: e
				})
			});
			t.src = e
...
! function(d) {
	...
	d.Tile.prototype = {
		...
		drawCanvas: function(e, t, i, n, o, r) {
			var s, a = this.position.times(d.pixelDensityRatio),
...
! function(h) {
	...
	h.Viewport.prototype = {
		...
		resize: function(e, t) {
			...
			this.viewer && this.viewer.raiseEvent("after-resize", {
				newContainerSize: e,
				maintain: t
			});
			return o
...
! function(y) {
	...
	y.extend(y.TiledImage.prototype, y.EventSource.prototype, {
		...
		_getTile: function(e, t, i, n, o, r, s) {
			var a, l, h, c, u, d, p, g, m, v = this.tilesMatrix,
				f = this.source;
			v[i] || (v[i] = {});
			v[i][e] || (v[i][e] = {});
		...
		_setTileLoaded: function(e, t, i, n) {
			...
			function l() {
				if (0 === --o) {
					...
					e.context2D || s._tileCache.cacheTile({
						data: t,
						tile: e,
						cutoff: i,
						tiledImage: s
